require.config({shim:{reg:["jquery","cookiebase"],login:["jquery","cookiebase"],index:["jquery","cookiebase","top","floor"],top:["jquery","cookiebase","template"],banner:["jquery"],floor:["jquery","template"],list:["jquery","top","template"],detail:["jquery","template"],aside:["jquery","template"],car:["jquery","template"]},paths:{jquery:"jquery-1.12.3",template:"template",cookiebase:"cookiebase",reg:"reg",login:"login",index:"index",top:"./index/top",banner:"./index/banner",floor:"./index/floor",list:"list",detail:"detail",aside:"aside",car:"car"}}),require(["jquery","reg","login","index","list","detail","car"],function(e,i,t,n,o,l,a){var r=location.pathname;console.log(r),"/VIP/reg/index.html"==r?i.init():"/VIP/login/index.html"==r?t.init():"/VIP/index/index.html"==r?n.init():"/VIP/list/index.html"==r?o.init():"/VIP/detail/index.html"==r?l.init():"/VIP/car/index.html"==r&&a.init()});
define(["jquery","template","cookiebase"],function(t,a,s){function n(){var a=this,s=this.aside();t("body").append(s),this.ajax(function(s){var s=JSON.parse(s);if(0!=s){var n={data:s},o=a.car_goods(n);t(".car_goods>ul").append(o),a.bind(),t(".car_num").html(t(".all_num").html())}})}return n.prototype.aside=a.compile("<div class='right_aside'>\t\t\t\t\t<div class='car_goods'>\t\t\t\t\t\t<h3>购物车商品，请尽快结算</h3>\t\t\t\t\t\t<ul>\t\t\t\t\t\t</ul>\t\t\t\t\t\t<p class='goods_all'><span class='all_num'>0</span>件商品<em></em></p>\t\t\t\t\t\t<button class='pray'>去购物袋结算</button>\t\t\t\t\t</div>\t\t\t\t\t<div class='car_shopping'>\t\t\t\t\t\t<p class='car_text'>购物袋</p>\t\t\t\t\t\t<span class='car_num'>0</span>\t\t\t\t\t</div>\t\t\t\t</div>"),n.prototype.car_goods=a.compile("{{each data as value index}}\t\t\t<li data-id = '{{value.list}}'>\t\t\t\t<img src='{{value.src}}' alt=''>\t\t\t\t<p>\t\t\t\t\t<span class='car_text'>{{value.name}}</span>\t\t\t\t\t<span class='car_number'>{{value.num}}</span>\t\t\t\t\t<span class='car_good_price'>¥<span class='g_price'>{{value.price}}</span></span>\t\t\t\t</p>\t\t\t</li>\t\t{{/each}}"),n.prototype.ajax=function(a){var s=getCookie("user"),n=s?JSON.parse(s):[];if(0!=n){var o=n[n.length-1].phone;t.ajax({type:"GET",url:"../php/aside.php",data:{username:o},success:function(t){a?a(t):console.log(t)},complete:function(){console.log("正在请求")},error:function(){console.log(arguments)},dataType:"jsonp"})}},n.prototype.bind=function(){t(".car_shopping").on("click",function(){var a=parseInt(t(".car_goods").css("right"));36!=a?t(".car_goods").animate({right:36}):t(".car_goods").animate({right:-274})});var a=0,s=0;t(".car_number").each(function(){a+=t(this).html()-0}),t(".all_num").html(a),t(".car_good_price").each(function(){s+=t(this).find(".g_price").html()-0}),t(".goods_all em").html("¥"+s)},n});
define(["jquery","template"],function(){return{init:function(){}}});
function getCookie(e){for(var o=document.cookie,t=o.split("; "),i=0;i<t.length;i++){var n=t[i].split("=");if(n[0]==e)return decodeURIComponent(n[1])}}function setCookie(e,o,t,i){var n="";if(void 0!=e&&void 0!=o){if(n+=e+"="+encodeURIComponent(o),t){var a=new Date;a.setDate(a.getDate()+t),n+=";expires="+a}i&&(n+=";path="+i),document.cookie=n}else alert("参数有问题")}
define(["jquery","template","top","aside"],function(t,a,e,i){return{init:function(){function o(){var a=this;this.ajax(function(e){var i={data:JSON.parse(e)},o=a.goods(i);t("#main").append(o),t(".little_img").on("click","img",function(){var a=t(this).prop("src");t(".img_box").css({background:"url("+a+") center","background-size":"cover"}),t(".big_Img").prop("src",a)}),t(".minu").click(function(){var a=t(".detail_number").html();console.log(a),a>1&&(a--,t(".detail_number").html(a))}),t(".add").click(function(){var a=t(".detail_number").html();a++,t(".detail_number").html(a)}),t(".img_box").hover(function(){var a=1100/420,e=t(this).height()*a;t(this).find(".big_Img").css({width:1100,height:e}),t(this).find(".big_box").css({display:"block"})},function(){t(this).find(".big_box").css({width:420,height:531,display:"none"})}),t(".img_box").mousemove(function(a){var e=a||event,i=t(".img_box"),o=t(".small_box"),s=t(".big_Img"),n=t(".big_box"),c=s.width()/i.width();o.width(n.width()/c),o.height(n.height()/c);var l=e.pageX-i.offset().left-o.width()/2,r=e.pageY-i.offset().top-o.width()/2;l<0?l=0:l>i.width()-o.width()&&(l=i.width()-o.width()),r<0?r=0:r>i.height()-o.height()&&(r=i.height()-o.height()),t(".small_box").css({left:l,top:r}),t(".big_Img").css({left:-l*c,top:-r*c})}),t(".car_shopping").on("click",function(){var a=parseInt(t(".car_goods").css("right"));36!=a?t(".car_goods").animate({right:36}):t(".car_goods").animate({right:-274})}),t(".buy").on("click",function(){var e=t(":radio:checked");if(void 0!=e[0]){a.shopping_ajax(function(t){}),t(".goods_size").removeClass("goods_size_error");t(".car_goods").animate({right:36},function(){var e=t(".big_Img"),i=e.clone(),o=t(".buy").offset();i.appendTo("body"),i.css({position:"absolute",left:o.left,top:o.top,width:49,height:61,"z-index":1111111});var s=t(".car_goods").offset();i.animate({left:s.left,top:s.top+50,width:0,height:0,opacity:0},1e3,function(){i.remove(),t(".car_goods>ul>li").remove(),a.aside_ajax(function(e){var i={data:JSON.parse(e)},o=a.car_goods(i);t(".car_goods>ul").append(o);var s=0,n=0;t(".car_number").each(function(){s+=t(this).html()-0}),t(".all_num").html(s),t(".car_good_price").each(function(){n+=t(this).find(".g_price").html()-0}),t(".goods_all em").html("¥"+n)});var e=0,o=(t(".car_number").html()-0)*(t(".act_price").html()-0),s=0;t(".car_number").each(function(){e+=t(this).html()-0}),t(".car_good_price").html(o),t(".all_num").html(e),t(".car_good_price").each(function(){s+=t(this).html()-0}),t(".goods_all em").html("¥"+s)})})}else t(".goods_size").addClass("goods_size_error")})})}e.init();new i;o.prototype.car_goods=a.compile("{{each data as value index}}\t\t\t\t\t<li data-id = '{{value.list}}'>\t\t\t\t\t\t<img src='{{value.src}}' alt=''>\t\t\t\t\t\t<p>\t\t\t\t\t\t\t<span class='car_text'>{{value.name}}</span>\t\t\t\t\t\t\t<span class='car_number'>{{value.num}}</span>\t\t\t\t\t\t\t<span class='car_good_price'>¥<span class='g_price'>{{value.price}}</span></span>\t\t\t\t\t\t</p>\t\t\t\t\t</li>\t\t\t\t{{/each}}"),o.prototype.goods=a.compile("{{each data as value index}}\t\t\t\t\t<div class='detail_wrap'>\t\t\t\t\t\t<div class='img_left'>\t\t\t\t\t\t\t<div class='img_box' style='background:url({{value.goodsImg}}) center;background-size:cover'>\t\t\t\t\t\t\t\t<div class='small_box'></div>\t\t\t\t\t\t\t\t<div class='big_box'><img src='{{value.goodsImg}}' class='big_Img'></div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class='little_img'>\t\t\t\t\t\t\t\t<img src='{{value.goodsImg}}' alt=''>\t\t\t\t\t\t\t\t<img src='{{value.goodss1}}' alt=''>\t\t\t\t\t\t\t\t<img src='{{value.goodss2}}' alt=''>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class='right_choice'>\t\t\t\t\t\t\t<h3>{{value.goodsName}}</h3>\t\t\t\t\t\t\t<div class='price'>\t\t\t\t\t\t\t\t<span class='rmb'>¥</span>\t\t\t\t\t\t\t\t<span class='act_price'>{{value.goodsPrice}}</span>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<table class='detail_msg'>\t\t\t\t\t\t\t\t<tr>\t\t\t\t\t\t\t\t\t<td>运费</td><td>（订单满288免运费）</td>\t\t\t\t\t\t\t\t</tr>\t\t\t\t\t\t\t\t<tr class='goods_size'>\t\t\t\t\t\t\t\t\t<td>尺码</td>\t\t\t\t\t\t\t\t\t<td>\t\t\t\t\t\t\t\t\t\t<span class='choice_num'><input type='radio' name='size' value='S'> S</span>\t\t\t\t\t\t\t\t\t\t<span class='choice_num'><input type='radio' name='size' value='M'> M</span>\t\t\t\t\t\t\t\t\t\t<span class='choice_num'><input type='radio' name='size' value='L'> L</span>\t\t\t\t\t\t\t\t\t\t<span class='choice_num'><input type='radio' name='size' value='XL'> XL</span>\t\t\t\t\t\t\t\t\t</td>\t\t\t\t\t\t\t\t</tr>\t\t\t\t\t\t\t\t<tr>\t\t\t\t\t\t\t\t\t<td>数量</td>\t\t\t\t\t\t\t\t\t<td class='detail_num'>\t\t\t\t\t\t\t\t\t\t<p>\t\t\t\t\t\t\t\t\t\t\t<span class='minu'>-</span>\t\t\t\t\t\t\t\t\t\t\t<span class='detail_number'>1</span>\t\t\t\t\t\t\t\t\t\t\t<span class='add'>+</span>\t\t\t\t\t\t\t\t\t\t</p>\t\t\t\t\t\t\t\t\t</td>\t\t\t\t\t\t\t\t</tr>\t\t\t\t\t\t\t\t<tr>\t\t\t\t\t\t\t\t\t<td></td>\t\t\t\t\t\t\t\t\t<td><input type='button' value='加入购物袋' class='buy'></td>\t\t\t\t\t\t\t\t</tr>\t\t\t\t\t\t\t</table>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t{{/each}}"),o.prototype.aside_ajax=function(a){var e=getCookie("user"),i=e?JSON.parse(e):[],o=i[i.length-1].phone;t.ajax({type:"GET",url:"../php/aside.php",data:{username:o},success:function(t){a?a(t):console.log(t)},complete:function(){console.log("正在请求")},error:function(){console.log(arguments)},dataType:"jsonp"})},o.prototype.ajax=function(a){var e=location.search.split("="),i=e[1].split("&"),o=i[0],s=e[2];t.ajax({type:"GET",data:{type:o,id:s},url:"../php/detail.php",success:function(t){a?a(t):console.log(t)},complete:function(){console.log("正在请求")},error:function(){console.log(arguments)},dataType:"jsonp"})},o.prototype.shopping_ajax=function(a){var e=t(".detail_number").html(),i=location.search.split("="),o=i[1].split("&"),s=o[0],n=i[2],c=t(".username").html(),l=t(":radio:checked").prop("value"),r=s+"&"+n+"&"+e+"&"+l;t.ajax({type:"GET",data:{username:c,gid:r},url:"../php/shopping.php",success:function(t){a?a(t):console.log(t)},complete:function(){console.log("正在请求")},error:function(){console.log(arguments)}})};new o}}});
define(["jquery","cookiebase","top","banner","floor","aside"],function(n,o,i,e,t,s){return{init:function(){i.init(function(){n(document).scroll(function(){var o=n(window).scrollTop();n(".header_menu").position().top;o>=148?n(".header_menu").css({position:"fixed",top:0}):n(".header_menu").css({position:"absolute",top:148})})}),e.init(),t.init();new s}}});
...
define(["jquery","top","template","aside"],function(t,a,s,o){return{init:function(){function e(){var a=this;this.ajax.banner(function(s){var o={data:JSON.parse(s)},e=a.template.banner(o);t(".list_banner").append(e)}),this.ajax.list(function(s){var o={data:JSON.parse(s)},e=a.template.list(o);t(".list_goods").append(e),t(".list_goods>ul").on("click","li",function(){var a=location.search,s=t(this).attr("data-id"),o=a+"&id="+s,e="http://10.3.135.48/VIP/detail/index.html"+o;t(this).find("a").attr("href",e),location.assign(e)}),t(".aImg>img").mouseover(function(){for(var a=t(this).attr("src"),s=t(this).closest(".goods_images")[0],o=s.getElementsByClassName("goods_img"),e=0;e<o.length;e++){var i=o[e].getElementsByClassName("aImg")[0];i.setAttribute("class","aImg")}t(this).closest(".goods_inner").find(".goods_act").children("img").attr("src",a),t(this).closest(".aImg").addClass("goods_active")}),t("list_goods li").on("click",function(){location.search,t(this).attr("data-id")})})}a.init();new o;t(".choose").load("../html/list/list.html",function(){}),e.prototype.template={banner:s.compile("{{each data as value index}}\t\t\t\t\t\t<img src='{{value.src}}' alt=''>\t\t\t\t\t {{/each}}\t\t\t\t\t"),list:s.compile("<ul>\t\t\t\t\t\t{{each data as value index}}\t\t\t\t\t\t\t<li data-id = {{value.goodsId}}> \t\t\t\t\t\t\t\t<div class='goods_inner'>\t\t\t\t\t\t\t\t\t<a href='' class='goods_act'><img src='{{value.goodsImg}}' alt=''></a>\t\t\t\t\t\t\t\t\t<div class='goods_images'>\t\t\t\t\t\t\t\t\t\t<div class='goods_img'>\t\t\t\t\t\t\t\t\t\t\t<a href='' class='goods_active aImg'><img src='{{value.goodsImg}}' alt=''></a>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t<div class='goods_img'>\t\t\t\t\t\t\t\t\t\t\t<a href='' class='aImg'><img src='{{value.goodss1}}' alt=''></a>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t<div class='goods_img'>\t\t\t\t\t\t\t\t\t\t\t<a href='' class='aImg'><img src='{{value.goodss2}}' alt=''></a>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t<p class='goods_info'>\t\t\t\t\t\t\t\t\t\t<span class='goods_discount'>2.5折</span>\t\t\t\t\t\t\t\t\t\t<p class='goods_price'>\t\t\t\t\t\t\t\t\t\t\t<em>\t\t\t\t\t\t\t\t\t\t\t\t<span class='RMB'>¥</span>\t\t\t\t\t\t\t\t\t\t\t\t<span class='price'>{{value.goodsPrice}}</span>\t\t\t\t\t\t\t\t\t\t\t</em>\t\t\t\t\t\t\t\t\t\t\t<del>\t\t\t\t\t\t\t\t\t\t\t\t<span>¥1598</span>\t\t\t\t\t\t\t\t\t\t\t</del>\t\t\t\t\t\t\t\t\t\t</p>\t\t\t\t\t\t\t\t\t\t<p class='goods_text'><a href=''>{{value.goodsName}}</a></p>\t\t\t\t\t\t\t\t\t</p>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</li>\t\t\t\t\t\t{{/each}}\t\t\t\t\t</ul>")},e.prototype.ajax={banner:function(a){var s=location.search.split("="),o=s[1];t.ajax({type:"GET",data:{type:o},url:"../php/list/banner.php",success:function(t){a?a(t):console.log(t)},complete:function(){console.log("正在请求")},error:function(){console.log(arguments)},dataType:"jsonp"})},list:function(a){var s=location.search.split("="),o=s[1];console.log(o),t.ajax({data:{type:o},type:"GET",url:"../php/list/list.php",success:function(t){a?a(t):console.log(t)},error:function(){console.log(arguments)},dataType:"jsonp"})}};new e}}});
define(["jquery","cookiebase"],function(o,r){return{init:function(){var r=this;o("#login").load("../html/login/login.html",function(){r.cookie();var s={};o(".user").val()?s.name=!0:s.name=!1,o(".psw").val()?s.psw=!0:s.psw=!1;var t=!0;o(".login_btn").click(function(){for(var o in s)s[o]||(t=!1);return t?r.ajax():t=!0,!1}),o(".user").on("keyup",function(){o(this).val()?(o(this).css({"border-color":"#333"}),o(".user_error").css({opacity:0,bottom:0})):(o(this).css({"border-color":"red"}),o(".user_error").html("请输入登录名").css({opacity:1,bottom:-24}))}),o(".psw").on("keyup",function(){o(this).val()?(o(this).css({"border-color":"#333"}),o(".psw_error").css({opacity:0,bottom:0})):(o(this).css({"border-color":"red"}),o(".psw_error").html("请输入密码").css({opacity:1,bottom:-24}))})})},cookie:function(){var r=getCookie("user"),s=r?JSON.parse(r):[];s&&(o(".user").val(s[s.length-1].phone),o(".psw").val(s[s.length-1].psw))},ajax:function(){o.ajax({type:"POST",url:"../php/login.php",success:function(r){var r=JSON.parse(r);200==r.status?location.assign("http://10.3.135.48/VIP/index/index.html"):o(".psw_error").html("登录名或密码错误").css({opacity:1,bottom:-24})},error:function(){console.log(arguments)},data:{name:o(".user").val(),psw:o(".psw").val()}})}}});
define(["jquery","cookiebase"],function(o,e){return{init:function(){var e=this;o("#reg").load("../html/reg/reg.html",function(){var r={},n=!0;o(".reg_btn").click(function(){for(var o in r)r[o]||(n=!1);return n?(e.cookie(),e.ajax()):n=!0,!1}),r.agree=o(".reg_agree").prop("checked"),o(".reg_agree").on("change",function(){r.agree=o(this).prop("checked")}),o(".phone_Num").on("focus",function(){var e=o(".phone_Num").val();!e.length>0?o(".phone_error").html("手机号码不能为空").animate({opacity:1,top:-35}):/^1[3|4|5|8][0-9]\d{4,8}$/.test(e)||o(".phone_error").html("请输入正确的手机号！").animate({opacity:1,top:-35})}),o(".phone_Num").on("blur",function(){o(".phone_error   ").animate({opacity:0,top:-45})}),o(".phone_Num").on("keyup",function(){var e=o(".phone_Num").val();/^1[3|4|5|8][0-9]\d{4,8}$/.test(e)?(o(this).css({background:"#fff","border-color":"#999"}),r.phone=!0):(o(this).css({background:"#ffe6e7","border-color":"#fca1a5"}),r.phone=!1)}),o(".psw").on("focus",function(){var e=o(".psw").val();!e.length>0?o(".psw_error  ").html("密码不能为空").animate({opacity:1,top:-35}):/^[0-9a-zA-Z]{6,20}$/.test(e)||o(".psw_error  ").html("密码由6-20位字母，数字和符号组合").animate({opacity:1,top:-35})}),o(".psw").on("blur",function(){o(".psw_error  ").animate({opacity:0,top:-45})}),o(".psw").on("keyup",function(){var e=o(".psw").val();/^[0-9a-zA-Z]{6,20}$/.test(e)?(o(this).css({background:"#fff","border-color":"#999"}),r.psw=!0):(o(this).css({background:"#ffe6e7","border-color":"#fca1a5"}),r.psw=!1)}),o(".checked_psw ").on("focus",function(){var e=o(".checked_psw ").val();!e.length>0?o(".ch_psw_error").html("请确认密码").animate({opacity:1,top:-35}):o(".psw").val()!=o(".checked_psw").val()&&o(".ch_psw_error").html("两次密码输入不一致，请重新输入").animate({opacity:1,top:-35})}),o(".checked_psw ").on("blur",function(){o(".ch_psw_error").animate({opacity:0,top:-45})}),o(".checked_psw ").on("keyup",function(){o(".checked_psw ").val();o(".psw").val()==o(".checked_psw").val()?(o(this).css({background:"#fff","border-color":"#999"}),r.check_psw=!0):(o(this).css({background:"#ffe6e7","border-color":"#fca1a5"}),r.check_psw=!1)})})},cookie:function(){for(var e=getCookie("user"),r=e?JSON.parse(e):[],n=!1,t=0;t<r.length;t++)r[t].phone==o(".phone_Num").val()&&(n=!0);n||(r.push({phone:o(".phone_Num").val(),psw:o(".psw").val()}),setCookie("user",JSON.stringify(r),7,"/"))},ajax:function(){o.ajax({type:"POST",url:"../php/reg.php",success:function(e){var e=JSON.parse(e);200==e.status?location.assign("http://10.3.135.48/VIP/index/index.html"):(o(".reg_error").html("手机号码已注册，请更换，或立即登录").animate({opacity:1,top:15}),o(".phone_Num").css({background:"#ffe6e7","border-color":"#fca1a5"}),o(".phone_Num").on("blur",function(){o(".reg_error").animate({opacity:0,top:-45})}))},error:function(){console.log(arguments)},data:{phone:o(".phone_Num").val(),psw:o(".psw").val()}})}}});
